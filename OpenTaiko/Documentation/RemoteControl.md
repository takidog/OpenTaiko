...
`GET /songs` supports `query`, `genre`, `difficulty`, `minLevel`, `maxLevel`, `page`, and `pageSize`. Page size defaults to 100 and is limited to 500. Difficulty values are `easy`, `normal`, `hard`, `oni`, `ura`, `tower`, and `dan`.
